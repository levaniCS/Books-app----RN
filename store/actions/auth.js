...
export const signUp = (email, password) => {
  return async (dispatch) => {
    const response = await fetch(
      'https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyDPE4K3CmWMNidzRTayMNXvN0zBK99R1VE',
      {
        method: 'POST',
        headers: {
...
export const login = (email, password) => {
  return async (dispatch) => {
    const response = await fetch(
      'https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyDPE4K3CmWMNidzRTayMNXvN0zBK99R1VE',
      {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json'
